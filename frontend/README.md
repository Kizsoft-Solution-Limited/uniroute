...
- `VITE_API_BASE_URL` - Backend API base URL (default: `http://localhost:8084` in dev, `https://app.uniroute.co` in prod)
...
- **Production** (`npm run build`): Uses `https://app.uniroute.co` by default
