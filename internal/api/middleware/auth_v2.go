...
// AuthMiddlewareV2 creates middleware for API key authentication (database-backed)
func AuthMiddlewareV2(apiKeyService *security.APIKeyServiceV2) gin.HandlerFunc {
