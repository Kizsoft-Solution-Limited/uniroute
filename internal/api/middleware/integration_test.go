...
func TestAuthMiddlewareV2_Integration(t *testing.T) {
	...
	middleware := AuthMiddlewareV2(apiKeyService)
	middleware(c)
...
func TestRateLimitMiddleware_Integration(t *testing.T) {
	...
	middleware := RateLimitMiddleware(rateLimiter, func(identifier string) (int, int) {
...
func TestFullMiddlewareFlow_Integration(t *testing.T) {
	...
	api := r.Group("/v1")
	api.Use(AuthMiddlewareV2(apiKeyService))
	api.Use(RateLimitMiddleware(rateLimiter, func(identifier string) (int, int) {
