...
func TestModelBasedStrategy(t *testing.T) {
	strategy := &gateway.ModelBasedStrategy{}
...
func TestCostBasedStrategy(t *testing.T) {
	...
	strategy := gateway.NewCostBasedStrategy(calculator)
...
func TestLoadBalancedStrategy(t *testing.T) {
	strategy := gateway.NewLoadBalancedStrategy()
